<?PHP include("./inc/header.inc"); ?>
	...
	<div class="promo">
	<h1>YUI PHP Loader Utility: Using YUI Loader to Load the Calendar Control (Simple)</h1>
	...
	<div class="exampleIntro">
        ...
        <p>This example loads in new window to demonstrate the simplest use case &mdash; a page with no other content, wherein the Loader is introducing YUI into a simple context.</p>	
	</div>	
					
	<div class="example-container module  newWindow">
		<div id="example-canvas" class="bd">
		<p class="newWindowButton yui-skin-sam"><span id="newWindowLink"><span class="first-child"><a href="phploader-basic_source.php" target="_blank">View example in new window.</a></span></span>			
	</div>
	
	</div>			
	</div>
		
	<h2 class="first">A Simple Use Case: Using YUI PHP Loader to Load the Calendar Control</h2>
...
<ol>
  ...
  <li><strong>Ouput Loader results</strong></li>
</ol>
...
<p>In this example, we bring a YUI component onto the page using the <a href="http://developer.yahoo.com/yui/phploader/">YUI PHP 
Loader Utility</a>. This example implements YUI PHP Loader via a <code>YAHOO_util_Loader</code> instance.  We include the YUI PHP 
Loader script file, then specify in configuration which component we want loaded on the page &mdash; and what we want to do once 
it <em>is</em> loaded.</p>
